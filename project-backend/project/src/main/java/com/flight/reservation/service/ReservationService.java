    ...
    public ReservationResponse creerReservation(ReservationRequest request) {
        ...
        try {
            ...
            if (!vol.hasAvailableSeats(nombrePlaces)) {
                publishAuditEvent(volId, emailPassager, nombrePlaces, placesDisponiblesAvant, StatutReservation.FAILED, "Places insuffisantes", null);
            ...
            publishAuditEvent(volId, emailPassager, nombrePlaces, null, StatutReservation.FAILED, e.getMessage(), null);
            throw e;
        }
    }
